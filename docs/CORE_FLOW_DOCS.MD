...
These diagrams show how the contracts, backend API, frontend, and Telegram notifier interact after the XMTP removal. Use them to understand each major user journey.
...
sequenceDiagram
    ...
    C-->>B: true
    B->>D: add member to in-memory set
