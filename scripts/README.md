...
- Supports optional curve overrides via `CURVE_PRIMARY_STYLE` (`static`, `linear`, `exponential`) and `CURVE_PRIMARY_RATE_BPS`. When unset, the factory default exponential curve (11_000 bps) is applied automatically.
