...
describe("Extended reentrancy protection", function () {
  ...
  it("reverts with ExternalCallFailed when executeProposal is reentered", async function () {
    const proposalId = 0;
  ...
  it("reverts with ExternalCallFailed when claimMemberPool is reentered", async function () {
    const proposalId = 0;
