...
- **Chat UI** streams XMTP messages and sends new ones using the group inbox ID. A server “send” fallback exists only for CI/e2e and is disabled by default; do not enable it in production.
