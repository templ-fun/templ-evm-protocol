...
flowchart LR
    ...
    B -->|verify priest/chain (prod)| CHAIN
    B -->|newGroup| X[XMTP]
```
...
- Only pause/unpause, fee repricing, and treasury transfers are permitted. Token changes and arbitrary ERC-20/ETH withdrawals are disabled; member pool funds cannot be moved.
