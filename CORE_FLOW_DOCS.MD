...
- Only pause/unpause, fee repricing, and treasury transfers are permitted. Token changes, arbitrary ERC-20/ETH withdrawals, and member pool sweeps are disabled.
